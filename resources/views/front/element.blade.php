        ...
        <div class="sections-container">
            ...
            <div class="temporal-title">
                <div class="temporal-title-content">
                    ...
                    <span class="text-label">{{get_dinamic_field_value('element.read.text')}}</span>
                    <img 
            ...
            <!-- Tercer elemento: Video personalizado con imagen de fondo -->
            <div class="video-background-element" style="background-image: url('/storage/medias/original/{{$element->video_image}}')">
                <div class="video-overlay">
                    <!-- Icono de play con el clic para redirigir -->
                    <div class="play-icon-container" onclick="window.location.href='/{{\App::getLocale()}}/video/{{$element->id}}';">
                        <img 
                            src="/storage/images/round_play_icon.png" 
                            srcset="
                                /storage/images/round_play_icon.png 1x, 
                                /storage/images/round_play_icon@2x.png 2x, 
                                /storage/images/round_play_icon@3x.png 3x, 
                                /storage/images/round_play_icon@4x.png 4x" 
                            class="play-icon" 
                            alt="Play Icon">
                    </div>
                    <!-- Texto centrado debajo del icono con clic para redirigir -->
                    <div class="video-text" onclick="window.location.href='/video';">
                        <strong>{{$element->getFieldValue('title')}}</strong>
                        <img 
                            src="/storage/images/external-link-alt.png" 
                            srcset="
                                /storage/images/external-link-alt.png 1x, 
                                /storage/images/external-link-alt@2x.png 2x, 
                                /storage/images/external-link-alt@3x.png 3x, 
                                /storage/images/external-link-alt@4x.png 4x" 
...
<script>
    ...
    closeButton.addEventListener('click', () => {
        ...
        window.location.href = "/{{\App::getLocale()}}/floor/{{ $element->floor_id }}"; // Asegúrate de que esté en un formato de plantilla de Blade
    });
</script>